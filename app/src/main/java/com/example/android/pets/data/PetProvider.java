...
/**
 * Created by Ramon on 04/04/2018.
 */
...
public class PetProvider extends ContentProvider {
    ...
    private Uri insertPet(Uri uri, ContentValues values) {
        ...
        if (gender == null || !PetContract.PetEntry.isValidGender(gender)) {
            throw new IllegalArgumentException("Gênero é um campo obrigatório");
        }

        if (weight != null && weight < 0) {
            throw new IllegalArgumentException("Peso é um campo obrigatório");
        }

        // Obtém banco de dados com permissão de escrita
        SQLiteDatabase database = mDbHelper.getWritableDatabase();

        // Insere o novo pet com os valores dados
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            ...
            case PET_ID:
                ...
                break;
            default:
                throw new IllegalArgumentException("Delete não é suportado pela seguinte uri " + uri);
        }
